...
public static class OrganRelationLibrary
{
    ...
    static readonly Dictionary<Type, Type[]> DependencyWhitelist = new()
    {
        ...
        { typeof(MagicAttackAction), new[] { typeof(MagicProjectileAttackAction), typeof(MagicCooldownState), typeof(MagicElementAffinityState) } },
        { typeof(MagicProjectileAttackAction), new[] { typeof(PreyMemory), typeof(MagicCooldownState), typeof(MagicElementAffinityState) } },
        ...
        { typeof(DominantAscensionAction), new[] { typeof(MagicAttackAction), typeof(MagicElementAffinityState), typeof(MagicCooldownState) } },
        { typeof(SpaceMagicAction), new[] { typeof(MagicCooldownState), typeof(MagicElementAffinityState) } },
